...
import { VectorStoreStats } from "./vector-store-stats";
...
const mock: Record<string, Dataset[]> = {
  ...
  Documents: [
    // Mock data for Documents can be added here if needed
  ],
};
...
export function DatasetsTabs() {
  const [tab, setTab] = useState<"Documents">("Documents");
    ...
    <div className="space-y-4">
      ...
      >
        <TabsList>
          ...
          <TabsTrigger value="Documents">OpenAI Documents</TabsTrigger>
        </TabsList>
            ...
            <TableRow key={d.id}>
              ...
              <TableCell>
                <select
                  ...
                  value={d.status}
                  onChange={(e) =>
                    onChange(d.id, { status: e.target.value as any })
                  }
                >
              ...
              <TableCell>
                <TagInput
                  value={d.tags}
                  onChange={(tags) => onChange(d.id, { tags })}
                />
              </TableCell>
            </TableRow>
          ))}
